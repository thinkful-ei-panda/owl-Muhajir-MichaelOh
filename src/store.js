...
const inSession = participants.filter(participant => participant.inSession === true);

// console.log(inSession)

const notInSession = participants.filter(participant => participant.inSession === false);

// console.log(notInSession)

const onStage = participants.filter(participant => participant.onStage === true);

// const offStage = participants.filter(participant => participant.onStage === false);
